  ...
  return (
    ...
    >
      <NavbarBrand className="mr-4">
        ...
        >
          <p className="font-bold text-2xl bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
            Sphere
          </p>
        </motion.div>
      </NavbarBrand>
      ...
      <NavbarContent as="div" className="items-center gap-2" justify="end">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={toggleTheme}
          className="hidden sm:flex rounded-full bg-gray-100 dark:bg-gray-700 p-2.5 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
        >
          {theme === "light" ? (
