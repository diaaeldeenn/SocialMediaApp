                    ...
                    <CardBody className="px-6 py-6 space-y-4">
                      ...
                      >
                        <div className="p-3 bg-pink-100 dark:bg-pink-900/50 rounded-xl">
                          <FiUser className="text-xl text-pink-600 dark:text-pink-400" />
                        </div>
                        <div>
                          <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider font-medium">
                            Gender
              ...
              <div className="lg:col-span-3 space-y-6">
                ...
                >
                  <Card className="h-full shadow-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                    ...
                    <Divider className="dark:bg-gray-700" />
                    <CardBody className="px-6 py-6 h-full">
                      <form
                      ...
                      >
                        ...
                        <Input
                          ...
                          endContent={
                            ...
                            >
                              {showPassword ? (
                                <IoEye className="text-2xl cursor-pointer text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" />
                              ) : (
                                <IoEyeOff className="text-2xl cursor-pointer text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" />
                              )}
                            </motion.button>
                          }
                        />
